...
const summary = asyncHandler(async (Model, req, res) => {
  ...
  const currentCurrency = currency
    ...
    : String(settings["default_currency_code"]).toUpperCase();
  ...
  const totalInvoices = response[0].totalInvoice
    ? response[0].totalInvoice[0]
    : 0;
